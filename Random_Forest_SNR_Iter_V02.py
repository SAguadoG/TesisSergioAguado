...
# AUMENTACIÓN DE DATOS Y ENTRENAMIENTO
...
print("\nIniciando el entrenamiento del modelo Random Forest en datos con ruido aleatorio...")
...
plt.ylabel('Métricas')
plt.title('Rendimiento de Random Forest vs. Nivel de Ruido')
plt.legend()
plt.grid(True)
