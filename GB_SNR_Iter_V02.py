...
# CARACTERÍSTIVAS DE LA ENVOLVENTE
...
print("\nIniciando el entrenamiento del modelo Gradient Booster en datos con ruido aleatorio...")
...
for noise_db in noise_levels_db:
    ...
    y_pred = GradBoost.predict(X_test_normalized)
...
plt.ylabel('Métricas')
plt.title('Rendimiento de Gradient Booster vs. Nivel de Ruido')
plt.legend()
plt.grid(True)
