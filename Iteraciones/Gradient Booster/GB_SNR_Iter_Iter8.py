...
for noise_db in noise_levels_db:
    ...
    X_test_SNR_wavelet = scaler_wavelet.transform(X_test_SNR[:, 5:15])
    ...
    X_test_SNR_derivative = scaler_derivative.transform(X_test_SNR[:, 38:])
